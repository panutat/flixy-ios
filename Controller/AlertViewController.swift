...
class AlertViewController: UIViewController {
    ...
    var whiteColor = UIColorFromHex(0xFFFFFF, alpha: 1)
    ...
    override func viewDidLayoutSubviews() {
        ...
        if self.textView != nil {
            ...
            yPos += ceil(textRect.size.height) + padding/2 + 20
        }
    ...
    func info(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil) -> AlertViewResponder {
    ...
    func success(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil) -> AlertViewResponder {
    ...
    func warning(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil) -> AlertViewResponder {
    ...
    func danger(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil) -> AlertViewResponder {
    ...
    func show(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil, color: UIColor?=nil, iconImage: UIImage?=nil) -> AlertViewResponder {
        ...
        self.view.backgroundColor = UIColorFromHex(0x000000, alpha: 0.3)
        ...
        let buttonColor = UIImage.withColor(adjustBrightness(self.whiteColor, amount: 0.9))
        ...
        dismissButton.addTarget(self, action: #selector(AlertViewController.buttonTap), forControlEvents: .TouchUpInside)
        ...
        if let btnText = cancelButtonText {
            ...
            cancelButton.addTarget(self, action: #selector(AlertViewController.cancelButtonTap), forControlEvents: .TouchUpInside)
